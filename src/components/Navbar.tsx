        ...
        <div>
            <nav className="bg-white shadow-sm border-b border-gray-100 fixed w-full z-20 top-0 left-0">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 relative">
                    ...
                    <h2 className="logo text-xl font-bold tracking-widest text-purple-600">Social App</h2>
                    ...
                    <div className={`${!open ? 'hidden' : 'absolute top-16 right-4 w-52 bg-white shadow-xl border border-gray-100 rounded-xl p-2'} md:block md:static md:w-auto md:shadow-none md:border-none md:bg-transparent md:p-0 z-50 transition-all`}>
                        <ul className="flex flex-col gap-1 md:flex-row md:space-x-4 md:gap-0 font-medium">
                            ...
                            {isAuthed ? (
                                <>
                                    <li>
                                        <Link className="flex items-center gap-3 px-4 py-3 text-sm text-gray-700 rounded-lg hover:bg-purple-50 hover:text-purple-700 transition-colors" to={'/home'}>
                                    ...
                                    <li onClick={handleLogout} className="flex items-center gap-3 px-4 py-3 text-sm text-gray-700 rounded-lg hover:bg-purple-50 hover:text-purple-700 transition-colors cursor-pointer">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
